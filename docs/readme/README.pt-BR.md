<div align="center">
  ...
  <p>
    <img src="https://img.shields.io/github/v/release/crynta/paterm?label=version&color=blue" alt="versão" />
...
Os instaladores mais recentes estão na página de [Releases](https://github.com/crynta/paterm/releases/latest). O Paterm se atualiza automaticamente por ela.
...
- **NixOS / Nix:** use o flake oficial com `nix profile install github:crynta/paterm` fora do NixOS. No NixOS, importe o flake e adicione `inputs.paterm.packages.${pkgs.system}.paterm` a `environment.systemPackages`. `nixosModules.paterm` também oferece uma configuração simplificada.
